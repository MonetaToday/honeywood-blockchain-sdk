...
type Params struct {
	...
	LockedSenders      []*AddressDenoms `protobuf:"bytes,3,rep,name=locked_senders,json=lockedSenders,proto3" json:"locked_senders,omitempty" yaml:"locked_senders,omitempty"`
	UnlockedSenders    []*AddressDenoms `protobuf:"bytes,4,rep,name=unlocked_senders,json=unlockedSenders,proto3" json:"unlocked_senders,omitempty" yaml:"unlocked_senders,omitempty"`
	LockedReceivers    []*AddressDenoms `protobuf:"bytes,5,rep,name=locked_receivers,json=lockedReceivers,proto3" json:"locked_receivers,omitempty" yaml:"locked_receivers,omitempty"`
	UnlockedReceivers  []*AddressDenoms `protobuf:"bytes,6,rep,name=unlocked_receivers,json=unlockedReceivers,proto3" json:"unlocked_receivers,omitempty" yaml:"unlocked_receivers,omitempty"`
}
...
func (m *Params) GetLockedSenders() []*AddressDenoms {
	if m != nil {
		return m.LockedSenders
	}
	return nil
}

func (m *Params) GetUnlockedSenders() []*AddressDenoms {
	if m != nil {
		return m.UnlockedSenders
	}
	return nil
}

func (m *Params) GetLockedReceivers() []*AddressDenoms {
	if m != nil {
		return m.LockedReceivers
	}
	return nil
}

func (m *Params) GetUnlockedReceivers() []*AddressDenoms {
	if m != nil {
		return m.UnlockedReceivers
	}
	return nil
}
...
func (m *AddressDenoms) Reset()         { *m = AddressDenoms{} }
func (m *AddressDenoms) String() string { return proto.CompactTextString(m) }
func (*AddressDenoms) ProtoMessage()    {}
func (*AddressDenoms) Descriptor() ([]byte, []int) {
	return fileDescriptor_dd052eee12edf988, []int{7}
}
func (m *AddressDenoms) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AddressDenoms) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AddressDenoms.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AddressDenoms) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AddressDenoms.Merge(m, src)
}
func (m *AddressDenoms) XXX_Size() int {
	return m.Size()
}
func (m *AddressDenoms) XXX_DiscardUnknown() {
	xxx_messageInfo_AddressDenoms.DiscardUnknown(m)
}

var xxx_messageInfo_AddressDenoms proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*AddressDenoms)(nil), "cosmos.bank.v1beta1.AddressDenoms")
}
...
var fileDescriptor_dd052eee12edf988 = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UnlockedReceivers) > 0 {
		for iNdEx := len(m.UnlockedReceivers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UnlockedReceivers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.LockedReceivers) > 0 {
		for iNdEx := len(m.LockedReceivers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LockedReceivers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.UnlockedSenders) > 0 {
		for iNdEx := len(m.UnlockedSenders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UnlockedSenders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.LockedSenders) > 0 {
		for iNdEx := len(m.LockedSenders) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.LockedSenders[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AddressDenoms) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AddressDenoms) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AddressDenoms) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Denoms) > 0 {
		for iNdEx := len(m.Denoms) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintBank(dAtA, i, uint64(len(m.Denoms[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Params) Size() (n int) {
	...
	if len(m.LockedSenders) > 0 {
		for _, e := range m.LockedSenders {
			l = e.Size()
			n += 1 + l + sovBank(uint64(l))
		}
	}
	if len(m.UnlockedSenders) > 0 {
		for _, e := range m.UnlockedSenders {
			l = e.Size()
			n += 1 + l + sovBank(uint64(l))
		}
	}
	if len(m.LockedReceivers) > 0 {
		for _, e := range m.LockedReceivers {
			l = e.Size()
			n += 1 + l + sovBank(uint64(l))
		}
	}
	if len(m.UnlockedReceivers) > 0 {
		for _, e := range m.UnlockedReceivers {
			l = e.Size()
			n += 1 + l + sovBank(uint64(l))
		}
	}
...
func (m *AddressDenoms) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockedSenders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LockedSenders = append(m.LockedSenders, &AddressDenoms{})
			if err := m.LockedSenders[len(m.LockedSenders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnlockedSenders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UnlockedSenders = append(m.UnlockedSenders, &AddressDenoms{})
			if err := m.UnlockedSenders[len(m.UnlockedSenders)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LockedReceivers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LockedReceivers = append(m.LockedReceivers, &AddressDenoms{})
			if err := m.LockedReceivers[len(m.LockedReceivers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnlockedReceivers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UnlockedReceivers = append(m.UnlockedReceivers, &AddressDenoms{})
			if err := m.UnlockedReceivers[len(m.UnlockedReceivers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AddressDenoms) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddressDenoms: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddressDenoms: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
